...
ParaParamSet::ParaParamSet()
{
  ...
  /** bool params */
   ...
   paraParams[CommunicateTighterBoundsInRacing] = new ParaParamBool(
          ...
          "# Communicate tighter bounds of variables in racing. [Default value: FALSE]",
          true);
   /*
   ...
   paraParams[HugeImbalanceActiveSolverRatio] = new ParaParamReal(
         ...
         "# Active solvers ratio to detect huge inbalance. If the active solvers ratio less than the value keeps until the threshold time, detect huge inbalance. [Default: 0.7][0.01, 0.99]",
         0.9,
         0.01,
         0.99);
